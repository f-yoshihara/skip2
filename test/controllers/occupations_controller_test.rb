...
class OccupationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occupation" do
    assert_difference('Occupation.count') do
      post occupations_url, params: { occupation: { category: @occupation.category, interests_count: @occupation.interests_count } }
    end
  ...
  test "should update occupation" do
    patch occupation_url(@occupation), params: { occupation: { category: @occupation.category, interests_count: @occupation.interests_count } }
