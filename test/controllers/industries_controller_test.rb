...
class IndustriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create industry" do
    assert_difference('Industry.count') do
      post industries_url, params: { industry: { category: @industry.category, interests_count: @industry.interests_count } }
    end
  ...
  test "should update industry" do
    patch industry_url(@industry), params: { industry: { category: @industry.category, interests_count: @industry.interests_count } }
