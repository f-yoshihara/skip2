...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post interests_url, params: { interest: { industry_id: @interest.industry_id, occupation_id: @interest.occupation_id, student_id: @interest.student_id } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { industry_id: @interest.industry_id, occupation_id: @interest.occupation_id, student_id: @interest.student_id } }
